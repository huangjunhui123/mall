...
public class RegexUtils {
    ...
    private static Pattern IS_LETTER_PATTERN = Pattern.compile("([a-z]|[A-Z])*");
    ...
    /**
     * 验证URL地址
     * @param url 格式：http://blog.csdn.net/weixin_38824230/article/details/73936630 或 http://www.csdn.net:80
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    public static boolean isAbc(String tap) {
        return IS_LETTER_PATTERN.matcher(tap).matches();
    }
}
